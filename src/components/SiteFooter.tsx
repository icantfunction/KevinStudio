...
export default function SiteFooter() {
  return (
    <footer className="border-t border-neutral-200 bg-[var(--background)] pt-20 pb-12">
      <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[2fr,1fr,1fr]">
        <div className="max-w-sm">
          <Link href="/" className="text-[0.7rem] font-semibold uppercase tracking-[0.4em] text-neutral-900">
            {siteConfig.name}
          </Link>
      ...
      <div className="mt-20 border-t border-neutral-100 pt-8 text-center text-[0.65rem] uppercase tracking-[0.3em] text-neutral-400">
